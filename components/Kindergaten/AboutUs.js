          ...
          <div className="col-lg-6 col-md-12">
            <div className="about-content">
              ...
              <ul className="about-list">
                <li>
                  <span>
                    <i className="bx bx-check"></i> Transportation
                  </span>
                </li>
                <li>
                  <span>
                    <i className="bx bx-check"></i> Outdoor Games
                  </span>
                </li>
                <li>
                  <span>
                    <i className="bx bx-check"></i> Nutritious Food
                  </span>
                </li>
                <li>
                  <span>
                    <i className="bx bx-check"></i> Best Care
                  </span>
                </li>
              </ul>

              <Link legacyBehavior href="/about-5">

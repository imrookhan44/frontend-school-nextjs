          ...
          <div className="col-lg-6 col-md-12">
            <div className="experience-content">
              ...
              <ul className="features-list">
                <li>
                  <i className="bx bx-check"></i> Vegetable Intake
                </li>
                <li>
                  <i className="bx bx-check"></i> An Apple a Day
                </li>
                <li>
                  <i className="bx bx-check"></i> Good Nutrition
                </li>
                <li>
                  <i className="bx bx-check"></i> Our Principles
                </li>
                <li>
                  <i className="bx bx-check"></i> Healthy Life
                </li>
                <li>
                  <i className="bx bx-check"></i> Personalized Plan
                </li>
              </ul>
